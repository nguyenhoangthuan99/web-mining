...
class Social_Encoder(nn.Module):
    ...
    def __init__(self, features, embed_dim, social_adj_lists, aggregator, base_model=None, cuda="cpu"):
        ...
        self.device = cuda
        self.linear1 = nn.Linear(self.embed_dim, self.embed_dim) # nn.Linear(2 * self.embed_dim, self.embed_dim)  #
    ...
    def forward(self, nodes):
        ...
        combined = self_feats#torch.cat([self_feats, neigh_feats], dim=1)#
